...
class VideoPlayerView2: UIView {

    // Properties for displaying video and for funcioning well
    var videoURL: URL!
    var player: AVPlayer!
    var currentPlayingTime: CMTime = CMTime()
    ...
    init(frame: CGRect, url: URL) {
        ...
        self.videoURL = url
        self.videoURL = URL(string: "http://d26lcc3xloewa9.cloudfront.net/Equine+Walk+300fps_Generic_Hd_Mp4_Avc_Aac_16x9_Sdr_1280x720p_30Hz_5000Kbps_Qvbr_Vq9.mp4")

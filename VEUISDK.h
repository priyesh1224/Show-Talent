...
#import "VEUISDKConfigure.h"
#import <Photos/Photos.h>

@interface VEUISDK : NSObject<NSMutableCopying,NSCopying>

NS_ASSUME_NONNULL_BEGIN
@property (nonatomic,weak) id <VEUISDKDelegate> delegate;
/**   视频导出设置
 */
...
/**相册选择视频完成回调
 */
@property (nonatomic,copy)VEAddVideosAndImagesCallbackBlock addVideosAndImagesCallbackBlock;
@property (nonatomic,copy)VEAddVideosCallbackBlock addVideosCallbackBlock;
@property (nonatomic,copy)VEAddImagesCallbackBlock addImagesCallbackBlock;
 ...
 */
@property(nonnull, copy) void (^VECutVideoReturnTypeBlock)(VECutVideoReturnType*);
 ...
 *
 */
typedef void (^VETrimAssetCallbackBlock)(VECutVideoReturnType cutType,AVURLAsset *asset,CMTime startTime,CMTime endTime, CGRect cropRect);
typedef void (^VETrimVideoPathCallbackBlock)(VECutVideoReturnType cutType,NSString * videoPath,CMTime startTime,CMTime endTime, CGRect cropRect);
...
- (instancetype) initWithAPPKey:(NSString *)appkey
                     ...
                     resultFail:(VEFailBlock )resultFailBlock;
/**  初始化对象
 *
 *  @param appkey          appkey description
 *  @param appsecret       appsecret description
...
- (BOOL)onVEAlbumWithSuperController:(UIViewController *)viewController
                         ...
                         cancelBlock:(VECancelBlock) cancelBlock;
...
- (void)trimVideoWithSuperController:(UIViewController *)viewController
         ...
         cancelButtonBackgroundColor:(UIColor  *) cancelButtonBackgroundColor
          ...
          otherButtonBackgroundColor:(UIColor  *) otherButtonBackgroundColor
                       ...
                       callbackBlock:(VETrimAssetCallbackBlock) callbackBlock
                            failback:(VEFailBlock       ) failback
                              cancel:(VECancelBlock     ) cancelBlock;
...
- (void)trimVideoWithSuperController:(UIViewController *)viewController
         ...
         cancelButtonBackgroundColor:(UIColor  *) cancelButtonBackgroundColor
          ...
          otherButtonBackgroundColor:(UIColor  *) otherButtonBackgroundColor
                          ...
                          outputPath:(NSString *) outputVideoPath
                       callbackBlock:(VETrimVideoPathCallbackBlock) callbackBlock
                            failback:(VEFailBlock       ) failback
                              cancel:(VECancelBlock     ) cancelBlock;
...
/**设置截取返回类型
 */
- (void)trimVideoWithType:(VECutVideoReturnType )type;
...
- (void)editVideoWithSuperController:(UIViewController *)viewController
                       ...
                       clipTimeRange:(CMTimeRange )clipTimeRange
                                crop:(CGRect)crop
                          outputPath:(NSString *)outputVideoPath
                            callback:(VECallbackBlock )callbackBlock
                              cancel:(VECancelBlock )cancelBlock;
...
- (void)editVideoWithSuperController:(UIViewController *)viewController
                       ...
                       clipTimeRange:(CMTimeRange )clipTimeRange
                                crop:(CGRect)crop
                           musicInfo:(UIMusicInfo *)musicInfo
                          outputPath:(NSString *)outputVideoPath
                            callback:(VECallbackBlock )callbackBlock
                              cancel:(VECancelBlock )cancelBlock;
...
*  @param foldertype                      缓存文件夹类型 （Documents、Library、Temp,None)
*  @param appAlbumCacheName 需扫描的缓存文件夹名称
*  @param pHAssetArray         视频/图片(NSMutableArray <PHAsset*>)
*  @param outputVideoPath   视频输出路径
*  @param callbackBlock     完成编辑回调
*  @param cancelBlock       取消编辑回调
*/
- (void)editVideoWithSuperController:(UIViewController *)viewController
                          foldertype:(FolderType)foldertype
                   appAlbumCacheName:(NSString *)appAlbumCacheName
                        pHAssetArray:(NSMutableArray<PHAsset *>*)pHAssetArray
                           musicInfo:(UIMusicInfo *)musicInfo
                          outputPath:(NSString *)outputVideoPath
                            callback:(VECallbackBlock )callbackBlock
                              cancel:(VECancelBlock )cancelBlock;
...
- (void)dogePuzzleWithSuperController:(UIViewController *)viewController
                                   ...
                                   outputPath:(NSString *)outputVideoPath
                                     callback:(VECallbackBlock )callbackBlock
                                       cancel:(VECancelBlock )cancelBlock;
#pragma mark- 多格 相册
- (BOOL)dogePuzzleonVEAlbumWithSuperController:(UIViewController *)viewController
                                       albumType:(ALBUMTYPE)albumType
                                       callBlock:(OnAlbumCallbackBlock) callbackBlock
                                     cancelBlock:(VECancelBlock) cancelBlock;
...
- (void)videoRecordAutoSizeWithSourceController: (UIViewController*)source
                                  callbackBlock: (VERecordCallbackBlock)callbackBlock
                                 imagebackBlock: (VECallbackBlock)imagebackBlock
                                     faileBlock: (VEFailBlock)failBlock
                                         cancel: (VECancelBlock)cancelBlock;
/** 拍摄 录制
 */
...
- (void)douYinRecordWithSourceController: (UIViewController*)source
                              recordType: (VEDouYinRecordType)recordType
                           callbackBlock: (VERecordCallbackBlock)callbackBlock
                          imagebackBlock: (VECallbackBlock)imagebackBlock
                              faileBlock: (VEFailBlock)failBlock
                                  cancel: (VECancelBlock)cancelBlock;
...
- (void)cutVideoWithSuperController:(UIViewController *)viewController
        ...
        cancelButtonBackgroundColor:(UIColor  *) cancelButtonBackgroundColor
         ...
         otherButtonBackgroundColor:(UIColor  *) otherButtonBackgroundColor
                      ...
                      callbackBlock:(VETrimVideoPathCallbackBlock) callbackBlock
                           failback:(VEFailBlock       ) failback
                             cancel:(VECancelBlock     ) cancelBlock DEPRECATED_MSG_ATTRIBUTE("老接口不推荐使用");
/**偏小截取时间 默认6s
 */
...
/**默认选中小值还是大值
 */
@property (nonatomic,assign) VEDefaultSelectCutMinOrMax  defaultSelectMinOrMax DEPRECATED_ATTRIBUTE;

- (void)cutVideo_withCutType:(VECutVideoReturnType )type DEPRECATED_MSG_ATTRIBUTE("老接口不推荐使用");
...
- (void)videoRecordWithSourceController: (UIViewController*)source
                         cameraPosition: (AVCaptureDevicePosition )postion
                            ...
                            Record_Type: (Record_Type)record_Type
                             outputPath: (NSString*)outputPath
                              videoPath: (VECallbackBlock)callbackBlock
                                 cancel: (VECancelBlock)cancelBlock DEPRECATED_MSG_ATTRIBUTE("老接口不推荐使用");

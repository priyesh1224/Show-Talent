//
//  ThemetypetwoTableViewCell.swift
//  ShowTalent
//
...
class ThemetypetwoTableViewCell: UITableViewCell , UICollectionViewDelegate , UICollectionViewDataSource , UICollectionViewDelegateFlowLayout{

//
//  ThemetypefourTableViewCell.swift
//  ShowTalent
//
...
class ThemetypefourTableViewCell: UITableViewCell, UICollectionViewDelegate , UICollectionViewDataSource , UICollectionViewDelegateFlowLayout {
...
var currepretheme : pretheme?
    ...
    @IBOutlet weak var v1image: UIView!
    
    
    @IBOutlet weak var v2image: UIView!
    
    
    @IBOutlet weak var v4image: UIView!
    
    
    @IBOutlet weak var v3image: UIView!
    ...
    {
        v1image.layer.cornerRadius = v1image.frame.size.height/2
         v2image.layer.cornerRadius = v2image.frame.size.height/2
         v4image.layer.cornerRadius = v4image.frame.size.height/2
         v3image.layer.cornerRadius = v3image.frame.size.height/2

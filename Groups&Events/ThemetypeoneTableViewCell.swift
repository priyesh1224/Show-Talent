//
//  ThemetypeoneTableViewCell.swift
//  ShowTalent
//
...
class ThemetypeoneTableViewCell: UITableViewCell , UICollectionViewDelegate , UICollectionViewDataSource , UICollectionViewDelegateFlowLayout {

//
//  ThemetypefiveTableViewCell.swift
//  ShowTalent
//
...
class ThemetypefiveTableViewCell: UITableViewCell , UICollectionViewDelegate , UICollectionViewDataSource , UICollectionViewDelegateFlowLayout{
